    ...
    <>
      ...
      <div className="g-config-fields">
        ...
        <div className="g-checks">
          ...
          <label className="custom-check">
            <input type="checkbox" checked={config.includeDocs} onChange={(e) => handleChange('includeDocs', e.target.checked)} />
            <div className="box"><i className="fa-solid fa-check"></i></div>
            <span className="label-text">Include Code Documentation</span>
          </label>

          <label className="custom-check">
            <input type="checkbox" checked={config.includeTests} onChange={(e) => handleChange('includeTests', e.target.checked)} />
            <div className="box"><i className="fa-solid fa-check"></i></div>
