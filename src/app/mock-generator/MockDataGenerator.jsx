...
export default function MockDataGenerator() {
  ...
  const detectedLanguage = useMemo(() => {
    ...
    if (schemaInput.includes('model ') && schemaInput.includes('@id')) return 'graphql'; // Prisma approximation
  ...
  return (
    <div className="module-container">
      <ModuleHeader
        ...
        resultData={generatedData ? { type: 'mock', input: schemaInput, output: JSON.stringify(generatedData), rules, locale, rowCount, seed, dataQuality } : null}
      />
